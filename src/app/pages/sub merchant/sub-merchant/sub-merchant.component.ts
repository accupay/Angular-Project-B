...
@Component({
  selector: 'app-sub-merchant',
  templateUrl: './sub-merchant.component.html',
  styleUrls: ['./sub-merchant.component.scss']
})
export class SubMerchantComponent implements OnInit {
  activeId = 1;
  loading: boolean;
  mername: any;
  subname: any;
  ...
  submerchantregistration!: FormGroup;
  ...
  constructor(
    ...
    this.userRefId = retailerInfo?.account_refid;
  ...
  ngOnInit() {
    ...
    this.categortList();
    this.businessList();
    this.mername = this.MerchantId;

  }

  public initLoginForm(): void {
    this.submerchantregistration = new FormGroup({
      merchantId: new FormControl("", [Validators.required]),
      
      submerchantname: new FormControl("", [Validators.required]),
      ...
      mer_business_type: new FormControl("", []),
  ...
  submerchantRegitrationSubmit() {
    debugger;
   

    
    if (this.submerchantregistration.invalid) {
      for (const control of Object.keys(
        this.submerchantregistration.controls
      )) {
        this.submerchantregistration.controls[control].markAsTouched();
      }
      return;
    }
    
    this.user = this.submerchantregistration.value;

    const Submerchantdata = {
      merchant_legal_name: this.user.submerchantname,
    ...
    console.log(Submerchantdata)
    this.cacheService.getsubmerchantregistration(Submerchantdata).subscribe(
      (res: ResponseInterface) => {
        if (res.response_code === "200") {
          this.submerchantregistration.reset();
          Swal.fire({
            title: 'Success',
          ...
          this.submerchantregistration.reset(this.submerchantregistration.value)
  ...
  showmerchantname(event: any) {

    this.subname = event?.value?.name;
  ...
  get merchantId() {
    return this.submerchantregistration.get("merchantId")!;
  }

  get submerchantname() {
    return this.submerchantregistration.get("submerchantname")!;
  }

  get businessname() {
    return this.submerchantregistration.get("businessname")!;
  }
  get location() {
    return this.submerchantregistration.get("location")!;
  }
  get address1() {
    return this.submerchantregistration.get("address1")!;
  }
  get country() {
    return this.submerchantregistration.get("country")!;
  }
  get state() {
    return this.submerchantregistration.get("state")!;
  }
  get city() {
    return this.submerchantregistration.get("city")!;
  }
  get pincode() {
    return this.submerchantregistration.get("pincode")!;
  }
  get category() {
    return this.submerchantregistration.get("category")!;
  }
  get pan() {
    return this.submerchantregistration.get("pan")!;
  }
  get mer_business_type() {
    return this.submerchantregistration.get("mer_business_type")!;
  }
  get transactioncount() {
    return this.submerchantregistration.get("transactioncount")!;
  }
  get transactionamount() {
    return this.submerchantregistration.get("transactionamount")!;
  }
  get transactionlimit() {
    return this.submerchantregistration.get("transactionlimit")!;
  }
  get vpa() {
    return this.submerchantregistration.get("vpa")!;
  }
  get gstno() {
    return this.submerchantregistration.get("gstno")!;
  }

  get mobile_no() {
    return this.submerchantregistration.get("mobile_no")!;
  }
  get weburl() {
    return this.submerchantregistration.get("weburl")!;
  }
